...
class Sky:
    def __init__(self, horizon, style = 'level'):
        ...
        if self.style == 'overworld':
            palm_surfaces = import_folder('src/code/levels/graphics/overworld/palms')
            self.palms = []
            ...
            cloud_surfaces = import_folder('src/code/levels/graphics/overworld/clouds')
            self.cloud = []
...
class Water:
    def __init__(self, top, level_width):
        ...
        for tile in range(tile_x_amount):
            ...
            y = top
            sprite = AnimatedTile(192, x, y, 'src/code/levels/graphics/decoration/water')
...
class Clouds:
    def __init__(self, horizon, level_width, cloud_number):
        cloud_surf_list = import_folder('src/code/levels/graphics/decoration/clouds')
        min_x = -screen_width
